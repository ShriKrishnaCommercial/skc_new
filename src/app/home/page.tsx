                                      ...
                                      fill="currentColor"/><path fillRule="evenodd" clipRule="evenodd"
                                            ...
                                            <div className="mt-6">
                                                <h2 className="text-3xl font-extrabold tracking-tight text-gray-900">ABOUT
                                                    US</h2>
                                                <p className="mt-4 text-lg text-gray-500">In our quest for excellence,
                                                    Shri
                                                    Krishna Commercial was formed in 2010 with objective of becoming
                                                    specialisation in Electrical, Mechanical and Instrumentation
                                                    products
                                                    line. Since then Shri Krishna Commercial has grown many folds to
                                                    become
                                                    one of the best most sought after and reputed aggregators and
                                                    traders
                                                    with presence in in Jharkhand, West Bengal, Orissa and Chhattisgarh
                                                    and
                                                    other parts of India. In pursuance to our vision of becoming a
                                                    leading
                                                    one stop industrial supplies services and solutions we have
                                                    collaborated
                                                    and tied up with leading manufacturers and OEMs of various
                                                    Electrical,
                                                    Mechanical, Instrumentaion equipments, spares, fittings and
                                                    supplies.
                                                    While we have expanded our footprints to Four States, we are
                                                    tirelessly
                                            ...
                                            <blockquote>
                                                ...
                                                <footer className="mt-3">
                                                    <div className="flex items-center space-x-3">
                                                        ...
                                                        <div className="text-sm font-medium text-gray-700">DEEPAK
                                                            SHARMA,
                                    ...
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"
                                        ...
                                        <div className="mt-6">
                                            ...
                                            <p className="mt-2 text-sm text-black">We have a Long history of over the
                                                years catering to the demands of our customers for all sorts of High
                                                Quality
                                                electrical, instrumentation and mechanical products.</p>
                                        </div>
                                    </div>
                                    ...
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"
                                        ...
                                        <div className="mt-6">
                                            ...
                                            <p className="mt-2 text-sm text-black">We are engaged in supply and service
                                                of best quality electrical, instrumentation and mechanical products to
                                                our
                                                clients. We have highly reliable principals, OEMs and other service
                                                teams ,
                                    ...
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"
                                        ...
                                        <div className="mt-6">
                                            ...
                                            <p className="mt-2 text-sm text-black">We realize that our continued
                                                success is dependent on maximizing value for our customers and prompt
                                                and
                                                accurate delivery.</p>
                                        </div>
                                    </div>
                                    ...
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"
                                        ...
                                        <div className="mt-6">
                                            ...
                                            <p className="mt-2 text-sm text-black">With 10 years of experience, we have
                                                built our knowledge base in the industry, which is highly beneficial to
                                                us
